...
with graph.as_default():
    ####Graph input
    learning_rate = tf.placeholder(tf.int32, shape=[])
...
with tf.Session(graph=graph) as session:
    ...
    for epoch in range(nEpochs):
        ...
        for bStep in range(stepsPerEpocheTrain):
            ...
            batchInputs, batchSeqLengths, batchTargetIdxs, batchTargetVals, batchTargetShape = get_list_vals(bList, cm,
                                                                                                             imgW,
                                                                                                                mvn=True)
            feedDict = {inputX: batchInputs, targetIxs: batchTargetIdxs, targetVals: batchTargetVals,
                        targetShape: batchTargetShape, seqLengths: batchSeqLengths, learning_rate: lR}
        ...
        print('Val time ', time.time() - timeVS)
        # Write a checkpoint.
        checkpoint_file = os.path.join('./private/models/lp5/', 'checkpoint')
        saver.save(session, checkpoint_file, global_step=epoch)
# Defining graph
# Initializing
# Epoch 1 ...
# 0.001
# Train: CTC-loss  840735.401428
# Train: CER  0.968594498115
# Train time  6920.192693
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  244.643819094
# Epoch 2 ...
# 0.0009
# Train: CTC-loss  840725.603203
# Train: CER  0.968595103056
# Train time  7087.97847795
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  221.958678007
# Epoch 3 ...
# 0.00081
# Train: CTC-loss  840720.43399
# Train: CER  0.968511062328
# Train time  7074.26800513
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  242.648200035
# Epoch 4 ...
# 0.000729
# Train: CTC-loss  840722.296738
# Train: CER  0.968549309694
# Train time  7029.85893202
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  240.704885006
# Epoch 5 ...
# 0.0006561
# Train: CTC-loss  840720.093597
# Train: CER  0.968583954141
# Train time  7030.34411001
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  242.873250008
# Epoch 6 ...
# 0.00059049
# Train: CTC-loss  840730.559456
# Train: CER  0.968616732844
# Train time  6634.09504986
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  211.848309994
# Epoch 7 ...
# 0.000531441
# Train: CTC-loss  840719.438744
# Train: CER  0.968566039061
# Train time  6232.94498801
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  212.933470011
# Epoch 8 ...
# 0.0004782969
# Train: CTC-loss  840726.484428
# Train: CER  0.968577567513
# Train time  5886.53678799
# Val: CTC-loss  76301.9229507
# Val: CER  0.964174768051
# Val time  189.118495941
# Epoch 9 ...
# 0.00043046721