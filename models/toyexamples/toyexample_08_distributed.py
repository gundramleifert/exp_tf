# FOUND AT https://github.com/caicloud/tensorflow-demo/blob/master/distributed/mnist_dnn.py
...
flags.DEFINE_string("workers", "localhost:2223,localhost:2224",
                    "The worker url list, separated by comma (e.g. tf-worker1:2222,1.2.3.4:2222)")

flags.DEFINE_string("parameter_servers", "localhost:2222",
